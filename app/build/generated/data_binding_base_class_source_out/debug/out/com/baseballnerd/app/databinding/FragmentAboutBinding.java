...
public final class FragmentAboutBinding implements ViewBinding {
  ...
  private FragmentAboutBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton btnBack,
      @NonNull ConstraintLayout layoutHeader, @NonNull TextView tvHeader) {
  ...
  public static FragmentAboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAboutBinding((ConstraintLayout) rootView, btnBack, layoutHeader, tvHeader);
    }
